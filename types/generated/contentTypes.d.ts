...
export interface ApiDebugDebug extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::debug.debug'> &
      Schema.Attribute.Private;
...
export interface ApiFlightDataFlightData extends Struct.CollectionTypeSchema {
  collectionName: 'flights_data';
  info: {
    displayName: 'flightsData';
    pluralName: 'flights-data';
    singularName: 'flight-data';
  };
  options: {
    draftAndPublish: true;
  };
